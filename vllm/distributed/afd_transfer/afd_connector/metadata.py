...
"""AFD metadata definitions for communication between attention and FFN 
workers."""
...
class AFDConnectorMetadata:
    ...
    stage_idx: int
    seq_lens: list[
        int]  # Length of each sequence, supports variable length and multiple
    # sequences
    dtype: torch.dtype
    device: torch.device
    ...
    def __repr__(self) -> str:
        ...
        return (f"AFDConnectorMetadata(layer={self.layer_idx}, "
                ...
                f"seq_lens={self.seq_lens}, total_tokens={self.total_tokens}, "
